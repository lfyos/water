...
//		String parameter_directory_name=ek.scene_par.directory_name;
		...
		if((root_box=root_comp.get_component_box(true))==null)
			return;
		double my_root_box_distance;
		if((my_root_box_distance=root_box.distance())<const_value.min_value)
			return;
		for(root_box_distance=1.0;my_root_box_distance>=root_box_distance;)
