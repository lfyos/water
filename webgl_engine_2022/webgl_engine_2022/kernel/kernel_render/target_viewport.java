...
public class target_viewport 
{
	...
	private void init(double my_x,double my_y,double my_width,double my_height,int my_method_id,double my_clear_color[])
	{
		x			=my_x;
		y			=my_y;
		width		=my_width;
	...
	public target_viewport(double my_x,double my_y,double my_width,double my_height,int my_method_id,double my_clear_color[])
	{
		init(my_x,my_y,my_width,my_height,my_method_id,my_clear_color);
	}
	...
	public target_viewport(target_viewport my_viewport)
	{
		init(	my_viewport.x,my_viewport.y,my_viewport.width,my_viewport.height,
				my_viewport.method_id,my_viewport.clear_color);
	}
