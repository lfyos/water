	...
	sorted_component_name_id,part_component_id_and_driver_id,render)
{
	...
	for(var render_id=0;render_id<render_number;render_id++){
		...
		if(typeof(render.data_buffer[render_id])=="undefined")
			render.data_buffer[render_id]=new Array();
		...
		for(var part_id=0;part_id<part_number;part_id++){
			if(typeof(render.data_buffer[render_id][part_id])=="undefined")
				render.data_buffer[render_id][part_id]=new Array();
			...
			for(var buffer_id=0,buffer_number=id_array.length;buffer_id<buffer_number;buffer_id++){
				if(typeof(render.data_buffer[render_id][part_id][buffer_id])=="undefined")
					render.data_buffer[render_id][part_id][buffer_id]=new Array();
