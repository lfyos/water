...
public class proxy_downloader 
{
	...
	public engine_call_result download(client_request_response request_response,system_parameter system_par)
	{
		String file_name,request_url=request_response.implementor.get_url();
		...
		File f=new File(file_name=system_par.proxy_par.proxy_data_root_directory_name+file_name);
		if(!(f.exists())){
