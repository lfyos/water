...
{
	public int state,p0_component_id,px_component_id,function_id;
	public point p0,px,py;
	public long location_version_p0,location_version_px;
	public String tag_str;

	public distance_tag_item(
			int my_p0_component_id,int my_px_component_id,
			int my_function_id,
	...
	public distance_tag_item(point my_point,int my_component_id)
	{
		state=0;
	...
	public void set_function(client_information ci)
	{
		String str;
	...
	public void set_tag_str(int display_precision,engine_kernel ek,client_information ci)
	{
		...
		case 9://near far direction
			...
			pl=new plane(dir[function_id-7].x,dir[function_id-7].y,dir[function_id-7].z,0);
