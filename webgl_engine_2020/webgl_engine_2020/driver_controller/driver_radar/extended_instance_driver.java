...
public class extended_instance_driver extends instance_driver
{
	...
	public extended_instance_driver(component my_comp,int my_driver_id,engine_kernel ek)
	{
	...
	{
		return ((extended_component_driver)(comp.driver_array[driver_id])).response_event(ek,ci);
	}
}
