...
{
	private String render_parameter_file_name,render_parameter_file_charset;
	public extended_render_driver()
	{
		...
		render_parameter_file_name=null;
		render_parameter_file_charset=null;
	}
	public void destroy()
	{
		super.destroy();
	...
	{
		extended_render_driver erd			=new extended_render_driver();
		erd.render_parameter_file_name		=(render_parameter_file_name==null)		?null:new String(render_parameter_file_name);
		erd.render_parameter_file_charset	=(render_parameter_file_charset==null)	?null:new String(render_parameter_file_charset);
		return erd;
	}
			...
			system_parameter system_par,scene_parameter scene_par,client_request_response request_response)
	{
		...
		render_parameter_file_name		=shader_fr.directory_name+file_reader.separator(shader_fr.get_string());
		render_parameter_file_charset	=shader_fr.get_charset();
		return new String[] {render_list_file_name,render_parameter_file_charset};
	}
	...
	{
		file_reader.get_text(fw,render_parameter_file_name,render_parameter_file_charset);
	}
}
