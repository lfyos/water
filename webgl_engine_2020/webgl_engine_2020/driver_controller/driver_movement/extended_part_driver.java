...
public class extended_part_driver extends part_driver
{
	...
	public extended_part_driver(String my_sound_pre_string)
	{
		super();
	...
	{
		return new extended_part_driver(sound_pre_string);
	}
	...
	{
		return new extended_component_driver(my_component_part,fr,sound_pre_string,request_response);
	}
