...
public class extended_part_driver extends part_driver
{
	...
	public extended_part_driver(
			part p,String my_directory_component_name,String my_file_name,
	...
	{
		String text_component_name[]=new String[fr.get_int()];
		for(int i=0,ni=text_component_name.length;i<ni;i++)
			text_component_name[i]=fr.get_string();
		
		return new extended_component_driver(my_component_part,
			directory_component_name,file_name,fr.get_charset(),text_component_name,
			fr.get_boolean());
	}
