...
public class movement_focus_modifier extends modifier_driver
{
	...
	private int current_movement_id;
	...
	public movement_focus_modifier(int my_component_id,
			int my_follow_component_id[],location my_follow_component_location[],
			long start_time,movement_switch_camera_modifier my_swcm,int my_current_movement_id,
