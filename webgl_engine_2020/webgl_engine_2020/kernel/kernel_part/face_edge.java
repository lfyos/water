...
public class face_edge 
{
	...
	public face_edge(point my_start_point,point my_end_point,String my_extra_data,String my_parameter_material[])
	{
		curve_type="unknown";
		curve_parameter=null;
		
		start_point	=(my_start_point==null)?null:my_start_point;
		start_point_material=my_parameter_material;
		start_extra_data=my_extra_data;
		
		end_point	=(my_end_point	==null)?null:my_end_point;
		end_point_material=my_parameter_material;
		end_extra_data=my_extra_data;
		
		parameter_material=my_parameter_material;
