...
import kernel_mesh.edge_tessellation;
import kernel_mesh.edge_tessellation_default;
import kernel_mesh.edge_tesslation_external_point;
...
public class face_edge 
{
	...
	public face_edge(face_edge s)
	{
		...
		parameter_point_material		=new String[s.parameter_point_material.length];;
		for(int i=0,ni=parameter_point_material.length;i<ni;i++)
			parameter_point_material[i]=s.parameter_point_material[i];
	...
	public String parameter_point_material[];
	...
	private void clear()
	{
		...
		parameter_point_material=part_rude.default_material;
	...
	public face_edge(file_reader fr,double scale_value)
	{
		...
		parameter_point_material=new String[4];
		
		for(int i=0,ni=parameter_point_material.length;i<ni;i++)
				parameter_point_material[i]=fr.get_string();
