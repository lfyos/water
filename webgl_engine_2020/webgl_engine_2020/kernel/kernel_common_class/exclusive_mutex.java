...
public class exclusive_mutex 
{
	...
	{
		for(long sleep_time_length=4,max_time_length=64*1024;;){
			number_mutex_lock.lock();
			...
			number_mutex_lock.unlock();
			sleep_time_length=((long)Math.round(1.2*sleep_time_length))%max_time_length;
