			...
			user_statistics statistics_user,interface_statistics statistics_interface)
	{
		...
		if(engine_kernel_cont.initilization_flag){
			...
			if(engine_kernel_cont.ek.component_cont==null) {
				...
				if(engine_kernel_cont.ek.component_cont.root_component!=null)
					statistics_interface.engine_component_number+=engine_kernel_cont.ek.component_cont.root_component.component_id+1;
		...
		if(client_information==null){
			...
			client_information=new client_information(
					my_request_response,process_bar,engine_kernel_cont.ek,statistics_user,statistics_interface);
		}
