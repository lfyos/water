...
public class engine_kernel_container
{
	...
	public engine_kernel_container(
			...
			String my_scene_name,String my_link_name,engine_kernel_container my_next_engine_kernel_cont)
	{
		link_number=0;
		...
		next_engine_kernel_cont=my_next_engine_kernel_cont;
			...
			user_statistics statistics_user,interface_statistics statistics_interface)
	{
		...
		if(file_name!=null) {
			...
			return create_file_result(ek,ekcic.client_information,file_name[0],file_name[1]);
		}
	...
	public void destroy()
	{
		...
		engine_kernel_lock=null;
		link_number_lock=null;
		next_engine_kernel_cont=null;
	}
	public void forced_destroy()
	{
		...
		if(link_number_lock!=null) {
			link_number_lock.unlock();
			link_number_lock=null;
		}
		if(next_engine_kernel_cont!=null)
			next_engine_kernel_cont=null;
	}
}
