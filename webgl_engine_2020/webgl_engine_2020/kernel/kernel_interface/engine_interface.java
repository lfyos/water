...
public class engine_interface
{
			...
			client_request_response request_response,system_parameter system_par)
	{
		if(original_render==null){
			...
			pcps.execute_append();
			original_render.load_part(1<<part_type_id,1,part_loader_cont,system_par,null,pcps,null,null);
			
			original_render.create_bottom_box_part(pcps,request_response,system_par);
			pcps.execute_append();
			original_render.load_part(1<<part_type_id,2,part_loader_cont,system_par,null,pcps,null,null);
