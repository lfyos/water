...
public class new_converter
{
	private static void material(String source_file_name,String target_file_name,String file_charset)
	{
		...
		for(int i=0,ni=fr.get_int();i<ni;i++) {
			...
			fw.println("					\"texture_file\"			:	",
					(texture_file_name.compareTo("notexture")==0)?"null,":("\""+texture_file_name.replace('\\','/')+"\","));
	...
	public static void main(String args[])
	{
		...
		render_list("C:\\temp\\part\\render.list",null);
		
//		render_list("E:\\project\\part\\solidworks\\render.list",null);
//		render_list("E:\\project\\part\\other_part\\render.list",null);
//		render_list("E:\\project\\boat\\part\\render.list",null);
