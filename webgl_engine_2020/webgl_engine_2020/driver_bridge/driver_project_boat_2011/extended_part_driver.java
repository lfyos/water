...
public class extended_part_driver extends driver_opengl_fixed_pipeline.extended_part_driver
{
	...
	public part_rude create_mesh_and_material(
			...
			part_container_for_part_search pcps,system_parameter system_par)
	{
		...
		String str1=p.mesh_file_name,str2=p.material_file_name;
		
		p.mesh_file_name+=".liufuyan.bak";
		p.material_file_name+=".liufuyan.bak";
		
		part_rude ret_val=super.create_mesh_and_material(p,buffer_object_file_writer,pcps,system_par);

		file_writer.file_delete(p.directory_name+p.mesh_file_name);
		file_writer.file_delete(p.directory_name+p.material_file_name);
			
		p.mesh_file_name=str1;
		p.material_file_name=str2;
