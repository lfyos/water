...
public class system_scene
{
	...
	private scene_call_result system_call_switch(client_request_response request_response)
	{
		...
		client_interface_search_tree client_tree;
		...
		case "process_bar":
			client_tree=client_interface_search_tree_array[request_response.container_id];
			client=client_tree.get_client_interface(request_response,
					scene_kernel_search_tree,string_locker_container,scene_counter);
			if(client!=null)
