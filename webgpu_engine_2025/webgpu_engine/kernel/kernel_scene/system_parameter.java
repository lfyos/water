...
public class system_parameter
{
	...
	public system_parameter(String my_scene_data_path_name,String my_scene_temparatory_path_name)
	{
		...
		if((user_file_name=f.get_string())==null)
			...
			user_file_name=file_directory.
				replace_directory_special_char(user_file_name).trim();
		
		if((shader_file_name=f.get_string())==null)
			shader_file_name="";
		else
			shader_file_name=file_directory.
				replace_directory_special_char(shader_file_name).trim();
		
		if((environment_file_name=f.get_string())==null)
			environment_file_name="";
		else
			environment_file_name=file_directory.
				replace_directory_special_char(environment_file_name).trim();
		
		if((parameter_directory=f.get_string())==null)
			parameter_directory="";
		else {
			parameter_directory=file_directory.
					replace_directory_special_char(parameter_directory.trim());
		...
		if((language_change_file_name=f.get_string())==null)
			...
			language_change_file_name=file_directory.
				replace_directory_special_char(language_change_file_name);	

		String switch_server_url_file_name;
		if((switch_server_url_file_name=f.get_string())==null)
			switch_server_url_file_name="";
		else
			switch_server_url_file_name=file_directory.
				replace_directory_special_char(switch_server_url_file_name);	
