...
{
	public static change_name get_change_name(String class_charset)
	{
		common_reader reader=class_file_reader.get_reader("content_type.txt",
								get_content_type_change_name.class,class_charset);
		if(reader==null)
			return null;
