...
//		String extra_parameter_directory_name	=sk.scene_par.extra_directory_name;
		...
		String movement_file_name					=file_directory.replace_directory_special_char(fr.get_string());
		String design_file_name						=file_directory.replace_directory_special_char(fr.get_string());
		String temporary_file_directory				=file_directory.replace_directory_special_char(fr.get_string());
