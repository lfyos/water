	...
	init_data,		part_object,	part_driver,	render_driver,	scene)
{
	...
	{
		var ep;
		if(typeof(ep=scene.component_call_processor[component_id])!="object"){
			scene.component_call_processor[component_id]=new Object();
			ep=scene.component_call_processor[component_id];
		}
